...
system 'yay -Syu spotify exa bat fzf fd lazygit ripgrep github-cli postgresql postgresql-utils vim openssh discord obsidian wget curl python-pip visual-studio-code-bin google-chrome'
